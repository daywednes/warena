...
const data_set = {
    ...
    datasets: [{
        label: "949",
        lineTension: 0,
        backgroundColor: ['#6FAFD5', pie_color, pie_color, pie_color, pie_color, pie_color, pie_color, pie_color],
...
$(function() {
    ...
    var ctx = document.getElementById('ICTokenChart').getContext('2d');
